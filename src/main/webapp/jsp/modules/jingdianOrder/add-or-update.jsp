    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑景点购票</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">景点购票管理</li>
                        <li class="breadcrumb-item active">编辑景点购票</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">景点购票信息</h3>
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6">
                                        <label>数量</label>
                                        <input id="jingdianNumber" name="jingdianNumber" class="form-control"
                                               onchange="jingdianNumberChickValue(this)"  placeholder="数量">
                                    </div>
...
<script>
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function jingdianNumberChickValue(e){
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                jingdianId: "required",
                yonghuId: "required",
                jingdianNumber: "required",
                insertTime: "required",
            },
            messages: {
                jingdianId: "景点id不能为空",
                yonghuId: "用户id不能为空",
                jingdianNumber: "数量不能为空",
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#jingdianNumber").val(ruleForm.jingdianNumber);
