		...
		<div id="app">
			...
			<div class="layui-form-item">
                <div class="layui-block">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="meishiNewMoney" id="meishiNewMoney"  lay-verify="required|double"   placeholder="单价" autocomplete="off" class="layui-input" style="width: 500px">
