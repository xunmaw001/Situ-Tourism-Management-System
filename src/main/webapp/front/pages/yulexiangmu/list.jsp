            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">娱乐项目展示</span>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../yulexiangmu/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../yulexiangmu/detail.jsp?id='+item.id)"><span>{{item.yulexiangmuName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 yulexiangmuContent 字段去除无用字符 如果字段长度大于60  就截取到60
            yulexiangmuContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (jquery('#yulexiangmuName').val() != null && jquery('#yulexiangmuName').val() != "" && jquery('#yulexiangmuName').val() != "null" ) {
                param['yulexiangmuName'] = jquery('#yulexiangmuName').val();
                                            ...
                                            // 获取列表数据
            http.request('yulexiangmu/list', 'get', param, function(res) {
