              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">相册名:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="xiangcheName" id="xiangcheName"  placeholder="相册名"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">相册类型:</span>
                        <div class="layui-input-inline">
                            <select name="xiangcheTypes" id="xiangcheTypes" lay-filter="xiangcheTypes" style="width: 600px;">
