              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">人数:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="yulexiangmuNumber" id="yulexiangmuNumber"  lay-verify="integer|required"   placeholder="人数" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
