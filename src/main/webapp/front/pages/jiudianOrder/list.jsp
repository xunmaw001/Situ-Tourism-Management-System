...
<div id="app">
    ...
    <div class="line-container">
        <p class="line" style="background: #EEEEEE;"> 我的酒店购票 </p>
    </div>
    <!-- 标题 -->
                ...
                <div class="layui-tab-content">
                    <table class="layui-table" lay-skin="nob">
                        ...
                        <tr v-for="(item,index) in dataList" v-bind:key="index">
                            ...
                            <td style="width: 150px;">{{item.jiudianTime}}</td>
...
<script>
    var vue = new Vue({
        ...
        methods: {
            ...
            //列表查询
            ,pageList(jiudianOrderTypes) {
                this.jiudianOrderTypes = jiudianOrderTypes;
                // 获取列表数据
                layui.http.request('jiudianOrder/list', 'get', {
                    page: 1,
                    limit: this.limit,
                    jiudianOrderTypes: vue.jiudianOrderTypes
                }, function(res) {
                        ...
                        jump: function(obj, first) {
                            ...
                            if (!first) {
                                layui.http.request('jiudianOrder/list', 'get', {
                                    page: obj.curr,
                                    limit: obj.limit,
                                    jiudianOrderTypes: this.jiudianOrderTypes
                                }, function(res) {
            ...
            ,pay(id) {
                // 获取商品详情信息
                layui.http.requestJson(`jiudianOrder/pay`, 'PPST',{
                    id:id
                }, (res) => {
                    if(res.code==0){
                        layer.msg('支付成功', {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        // 获取列表数据
        http.request('jiudianOrder/list', 'get',{
            page: 1,
            limit: limit,
            jiudianOrderTypes: vue.jiudianOrderTypes
        }, function(res) {
                ...
                jump: function(obj, first) {
                    ...
                    if (!first) {
                        http.request('jiudianOrder/list', 'get', {
                            page: obj.curr,
                            limit: obj.limit,
                            jiudianOrderType: vue.jiudianOrderType
                        }, function(res) {
                            vue.dataList = res.data.list
                        })
                    }
