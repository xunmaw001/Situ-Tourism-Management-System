...
<div id="app">
    ...
    <div class="line-container">
        <p class="line" style="background: #EEEEEE;"> 我的景点购票 </p>
    </div>
    <!-- 标题 -->
                ...
                <div class="layui-tab-content">
                    <table class="layui-table" lay-skin="nob">
                        ...
                        <tr v-for="(item,index) in dataList" v-bind:key="index">
                            ...
                            <td style="width: 150px;">{{item.jingdianNumber}}</td>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 jingdianOrderContent 字段去除无用字符 如果字段长度大于60  就截取到60
            jingdianOrderContent: function(val) {
                if (val) {
        ...
        methods: {
            ...
            ,pageList(jingdianOrderTypes) {
                ...
                // 获取列表数据
                layui.http.request('jingdianOrder/list', 'get', {
                    page: 1,
                    limit: this.limit,
                    jingdianOrderTypes: vue.jingdianOrderTypes
                }, function(res) {
                        ...
                        jump: function(obj, first) {
                            ...
                            if (!first) {
                                layui.http.request('jingdianOrder/list', 'get', {
                                    page: obj.curr,
                                    limit: obj.limit,
                                    jingdianOrderTypes: this.jingdianOrderTypes
                                }, function(res) {
            ...
            ,pay(id) {
                // 获取商品详情信息
                layui.http.requestJson(`jingdianOrder/pay`, 'PPST',{
                    id:id
                }, (res) => {
                    if(res.code==0){
                        layer.msg('支付成功', {
                ...
                jump: function(obj, first) {
                    ...
                    if (!first) {
                        http.request('jingdianOrder/list', 'get', {
                            page: obj.curr,
                            limit: obj.limit,
                            jingdianOrderType: vue.jingdianOrderType
                        }, function(res) {
                            vue.dataList = res.data.list
                        })
                    }
