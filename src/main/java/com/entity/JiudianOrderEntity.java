...
public class JiudianOrderEntity<T> implements Serializable {
	...
	@DateTimeFormat
    @TableField(value = "jiudian_time",fill = FieldFill.UPDATE)

    private Date jiudianTime;
    ...
    public void setJiudianTime(Date jiudianTime) {
        this.jiudianTime = jiudianTime;
    }
    /**
	 * 设置：订单创建时间
	 */
