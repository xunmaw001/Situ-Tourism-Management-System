...
public class YulexiangmuCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public YulexiangmuCollectionEntity() {

	}

	public YulexiangmuCollectionEntity(T t) {
		try {
