 ...
 */
@TableName("yulexiangmu_collection")
public class YulexiangmuCollectionView extends YulexiangmuCollectionEntity implements Serializable {
	...
	public YulexiangmuCollectionView() {

	}

	public YulexiangmuCollectionView(YulexiangmuCollectionEntity yulexiangmuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, yulexiangmuCollectionEntity);
